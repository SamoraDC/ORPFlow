...
class XGBoostModel:
    """XGBoost model for return/signal prediction"""
    ...
    def export_onnx(self, path: str, feature_names: list):
        ...
        try:
            ...
            native_path = path.replace(".onnx", ".xgb")
...
def main():
    ...
    model.save(str(model_dir / "xgboost_model.pkl"))
    model.export_onnx(str(model_dir / "onnx" / "xgboost_model.onnx"), feature_names)
